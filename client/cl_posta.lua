exports.ox_target:removeModel(dnj.mlx.mdls, 'local')
...
exports.ox_target:addModel(dnj.mlx.mdls, {
    {
        name = 'local',
        ...
        onSelect = function(data)
            ...
            if lib.progressBar({
                ...
                local success = lib.skillCheck(dnj.mlx.skl, {'w', 'a', 's', 'd'})
                
                if success then
                 --   TriggerServerEvent('dnj:rm',"lockpick",1)
                    TriggerServerEvent('dnj_robberies:posta', entitycoords, token)
